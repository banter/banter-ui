<template>
  <div class="privacy-policy">
    ...
    <ul>
      ...
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
          &quot;Us&quot; or
          &quot;Our&quot; in this Agreement) refers to Banter Audio, 5 Evan Drive.</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Website</strong> refers to Banter, accessible from <a href="banteraudio.com"
            rel="external nofollow noopener" target="_blank">banteraudio.com</a></p>
      </li>
      <li>
    ...
    <p>Notwithstanding any damages that You might incur, the entire liability of the Company and any
      ...
      limited to the
      amount actually paid by You through the Service or 100 USD if You haven't purchased anything
      through the Service.
    </p>
    ...
    <p>Without limiting the foregoing, neither the Company nor any of the company's provider makes
      ...
      Service, or the
      information, content, and materials or products included thereon; (ii) that the Service will
      be uninterrupted or
    ...
    <ul>
      <li>By email: team@banteraudio.com</li>
    </ul>
  </div>
</template>
